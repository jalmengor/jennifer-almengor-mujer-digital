            ...
            <div id="shopping-cart">
                <div class="cart-summary">
                    ...
                    foreach ( $cart_items as $cart_id => $cart_item ) {
                        ...
                        $pricing_cat        =  $cart_item['trip_data']['pricings'][0]['categories'][0]['is_sale'] ? $cart_item['trip_data']['pricings'][0]['categories'][0]['sale_price'] : $cart_item['trip_data']['pricings'][0]['categories'][0]['regular_price'];

                        $trip_price_only         =  (int)$cart_item['trip'][ array_key_first( $cart_item['trip'] ) ]['pax'] * (int)$pricing_cat;
                        $total_trip_price += $trip_price_only;
                                ...
                                <div class="trip-content">
                                    <div class="trip-item-name-price">
                                        ...
                                        <span class="trip-price">
                                            <span data-wpt-item-total="<?php echo esc_attr( $trip_price_only ); ?>" >
                                        
                                                    <?php echo wptravel_get_formated_price_currency( WpTravel_Helpers_Trip_Pricing_Categories::get_converted_price( $trip_price_only ) ); ?>
                                            </span>
                                        </span>
                                    </div>
                    ...
                    $total_trip_price += (-(float)$discount);
                    ...
                    <ul class="extra-fields">
                        ...
                        if ( $coupon_type ) :
                            ...
                            <li style="<?php echo esc_attr( $display ); ?>" data-wpt-extra-field>
                                ...
                                <div class="price">
                                    <strong data-wpt-cart-discount="<?php echo esc_attr( $discount ); ?>"><?php echo '- ' . wptravel_get_formated_price_currency( WpTravel_Helpers_Trip_Pricing_Categories::get_converted_price( $discount ) ); ?></strong>
                                </div>
                            </li>
                            <?php
                        endif;
                        
                        if ( $coupon_applied || ( isset( $cart['cart']['total']['tax'] ) && $cart['cart']['total']['tax'] > 0 ) ) : ?>
                            <li data-wpt-extra-field>
                                <label><?php esc_html_e( 'Subtotal', 'wp-travel' ); ?></label>
                                <div class="price"><strong data-wpt-cart-subtotal="<?php echo esc_attr( $total_trip_price ); ?>"><?php echo wptravel_get_formated_price_currency( WpTravel_Helpers_Trip_Pricing_Categories::get_converted_price( $total_trip_price ) ); ?></strong></div>
                            </li>
                            <?php
                        endif;
                        ...
                        $tax      = ( $total_trip_price /100 ) * (float) $tax_rate;
                        $total_trip_price += $tax;
                        ?>
                        <li style="<?php echo esc_attr( $display ); ?>" data-wpt-extra-field>
                            <label>
                                <?php
                        ...
                        <li data-wpt-trip-total="<?php echo esc_attr( $total ); ?>" class="wp-travel-payable-amount selected-payable-amount" >
                            ...
                            <div class="price"><strong data-wpt-cart-net-total="<?php echo esc_attr( $total_trip_price ); ?>"><?php echo wptravel_get_formated_price_currency( WpTravel_Helpers_Trip_Pricing_Categories::get_converted_price( $total_trip_price ) ); ?></strong></div>
                        </li>
