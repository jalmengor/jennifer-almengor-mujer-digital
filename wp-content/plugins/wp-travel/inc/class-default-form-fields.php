...
class WP_Travel_Default_Form_Fields { // @phpcs:ignore
	...
	public static function traveller() {
		...
		// if( wptravel_get_settings()['enable_multiple_checkout'] == "no" ){
		...
		if( isset( wptravel_get_settings()['enable_multiple_checkout'] ) &&  wptravel_get_settings()['enable_multiple_checkout'] == "no" && isset( wptravel_get_settings()['enable_one_page_booking'] ) && wptravel_get_settings()['enable_one_page_booking'] == "" ){
			$cart = WP_Travel_Helpers_Cart::get_cart();
