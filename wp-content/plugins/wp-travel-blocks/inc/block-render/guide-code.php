...
/**
 * 
 * Render Callback For Guide Code
 * 
 */

function wptravel_block_guide_code_render( $attributes ) {
    ob_start();
    ...
    <p class="wptravel-guide-code-block">
        <?php 
            if( $guide_data ){ 
                echo '#'.esc_html( $guide_code ); 
            }else{
                echo esc_html__( '#TG2202403', 'wp-travel-blocks' );
            }
            
        ?>
    </p>
    <style>
        .wptravel-guide-code-block{
