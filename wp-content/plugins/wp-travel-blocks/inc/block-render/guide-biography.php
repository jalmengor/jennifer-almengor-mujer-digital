...
/**
 * 
 * Render Callback For Guide Biography
 * 
 */

function wptravel_block_guide_biography_render( $attributes ) {
    ob_start();
    ...
    <p class="wptravel-guide-biography-block">
        <?php 
            if( $guide_data ){                
    ...
    <style>
        .wptravel-guide-biography-block{
