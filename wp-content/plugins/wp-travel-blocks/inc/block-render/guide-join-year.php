...
/**
 * 
 * Render Callback For Guide Join Year
 * 
 */

function wptravel_block_guide_join_year_render( $attributes ) {
    ob_start();
    ...
    <p class="wptravel-guide-join-year-block">
        <?php 
            if( $guide_data ){ 
                echo esc_html( $guide_join_year ); 
            }else{
                echo esc_html__( '2024', 'wp-travel-blocks' );
            }
            
        ?>
    </p>
    <style>
        .wptravel-guide-join-year-block{
