...
/**
 * 
 * Render Callback For Guide Languages
 * 
 */

function wptravel_block_guide_language_render( $attributes ) {
    ob_start();
    ...
    <p class="wptravel-guide-language-block">
        <?php 
            if( $guide_data ){ 
                echo esc_html( $guide_language ); 
            }else{
                echo esc_html__( 'Language one, Language two', 'wp-travel-blocks' );
            }
            
        ?>
    </p>
    <style>
        .wptravel-guide-language-block{
